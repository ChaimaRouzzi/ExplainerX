...
const Encoding = () => {
  ...
  const handleClick = (newState) => () => {
    ...
    axios.get(url).then((response) => {
      ...
      const url2 = `http://127.0.0.1:8000/api/categorical/${val}/${updated.updated}`;
      ...
      handleUpdateVersion(all === 1 ? -1 : step).then(() => {
        ...
        axios
          ...
          .then((response) => {
            ...
            const url2 = `http://127.0.0.1:8000/api/categorical/${val}/False`;
            axios.get(url2).then((response) => {
              const result = JSON.parse(response.data);
              setTthresholdColumns(result);
              console.log(result);
      ...
      handleUpdateVersion(all === 1 ? -1 : step).then(() => {
        ...
        axios
          ...
          .then((response) => {
            ...
            const url2 = `http://127.0.0.1:8000/api/categorical/${val}/True`;
            axios.get(url2).then((response) => {
              const result = JSON.parse(response.data);
              setTthresholdColumns(result);
              setSelectedValue('');
  ...
  useEffect(() => {
    ...
    const url = `http://127.0.0.1:8000/api/categorical/${val}/${updated.updated}`;
            ...
            {isLoading2 ? (
              ...
              <div>
                {thresholdColumns.length > 0 ? (
                  ...
                  <Alert severity="warning">No categorical columns were found</Alert>
                )}{' '}
              </div>
            )}
          </MainCard>
