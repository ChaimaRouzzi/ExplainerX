...
const Scaling = () => {
  ...
  const handleClick = (newState) => () => {
    setLoading2(true);
    const url = `http://127.0.0.1:8000/api/time_series/${val}/${updated.updated}/${selectedMethod}/${selectedColumn}`;
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={6}>
                <Box sx={{ position: 'relative' }}>
                  <FormControl fullWidth variant="outlined">
                    <InputLabel> Transformation Method</InputLabel>
